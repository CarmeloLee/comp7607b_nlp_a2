...
def parse_args():
    ...
    parser.add_argument("--temperature", default=0.5, type=float) #0.85
    parser.add_argument("--top_p", default=0.7, type=float) #0.85
    ...
    parser.add_argument("--learning_rate", type=float, default=5e-7) #1e-8
    ...
    parser.add_argument("--warmup_iters", type=int, default=0.03) #0
    parser.add_argument("--log_interval", type=int, default=100)
    parser.add_argument("--save_interval", type=int, default=100)
    parser.add_argument("--local_rank", type=int, default=-1)
    parser.add_argument("--dim", default=512, type=int)
    parser.add_argument("--n_layers", default=8, type=int)
    parser.add_argument("--max_seq_len", default=512, type=int) #3000
